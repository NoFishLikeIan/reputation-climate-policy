...
```bash
julia --project ".\scripts\committed.jl" --sigma=0.031102896328155678;
julia --project ".\scripts\boundaries.jl" --sigma=0.031102896328155678;
julia --project ".\scripts\interior.jl" --sigma=0.031102896328155678
```
