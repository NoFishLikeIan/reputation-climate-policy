...
# ╔═╡ a1aba980-cae8-4930-a96c-4b3041cf8172
Base.@kwdef struct Consumer{T <: Real}
	α::T = 20.0
	β::T = 1.0
	d::T = 3.
end

# ╔═╡ 3f1608ea-1fc0-42e8-9ea0-5d9f5100f1c7
function consumersurplus(q, consumer::Consumer)
	(consumer.β / 2) * q
end;

# ╔═╡ 2748b09d-2e7f-496e-9fa8-5834da1420cc
function inversedemand(q, consumer::Consumer)
	consumer.α - consumer.β * q
end;

# ╔═╡ ef3c7039-5dfd-4029-9b16-e4d86d6028d2
md"## Producers"

# ╔═╡ 3d764e20-cd0c-412b-a6e1-23556a2f0937
Base.@kwdef struct Producer{T <: Real}
	e::T = 5.
	γ::T = 1.
	c::T = 1.
end
...
# ╔═╡ 84c82d92-a6c9-4a20-b282-06e52a1f044f
function profits(q, a, τ, producer::Producer, consumer::Consumer)
	inversedemand(q, consumer) * q - producer.c * q - abatementcosts(q, a, producer) - τ * emissions(q, a, producer)
end;

# ╔═╡ 37d91379-3d67-4ea8-8ea2-2d408d43946f
function damages(q, a, producer::Producer, consumer::Consumer)
	(consumer.d / 2) * emissions(q, a, producer)^2
end;

# ╔═╡ 05e078c9-273d-448c-9ab7-09f741a77507
function quantity(τ, producer::Producer, consumer::Consumer)
	@unpack α, β = consumer
	@unpack c, γ, e = producer
	
	(α - c - τ * e + (τ * e)^2 / 2γ) / 2β
end;

# ╔═╡ 562c0087-1592-4008-bf10-64602c03cad1
function abatement(τ, producer::Producer)
	@unpack γ, e = producer
